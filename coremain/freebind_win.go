...
// ListenTCPWithFreebind creates a TCP listener, but ignore the freebind option
...
// ListenUDPWithFreebind creates a UDP packet connection, but ignore the freebind option
